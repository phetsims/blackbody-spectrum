...
(3) Open `http://localhost/blackbody-spectrum/blackbody-spectrum_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
